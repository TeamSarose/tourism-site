    ...
    >
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:grid md:grid-cols-3 gap-8 space-y-6 md:space-y-0">
        ...
        <div className="text-center md:text-left text-sm">
          <h2 className="text-xl font-bold text-[var(--gold)] mb-3">About Us</h2>
        ...
        {/* Quick Links */}
        <div className="text-center md:text-left text-sm">
          <h2 className="text-xl font-bold text-[var(--gold)] mb-3">Quick Links</h2>
          <ul className="space-y-2 flex flex-col items-center md:items-start">
            <li><a href="#" className="hover:text-[var(--golden-orange)] transition-colors">Home</a></li>
            <li><a href="#destinations" className="hover:text-[var(--golden-orange)] transition-colors">Destinations</a></li>
            <li><a href="#culture" className="hover:text-[var(--golden-orange)] transition-colors">Culture</a></li>
            <li><a href="#location" className="hover:text-[var(--golden-orange)] transition-colors">Location</a></li>
            <li><a href="#contact" className="hover:text-[var(--golden-orange)] transition-colors">Contact</a></li>
          </ul>
        </div>
        {/* Contact & Social */}
        <div className="text-center md:text-left text-sm">
          <h2 className="text-xl font-bold text-[var(--gold)] mb-3">Contact Info</h2>
          ...
          <div className="flex flex-wrap justify-center md:justify-start gap-4 mt-2">
            <a href="https://facebook.com" aria-label="Facebook" target="_blank" rel="noopener noreferrer" className="bg-gray-800 hover:bg-[var(--golden-orange)] text-gray-300 hover:text-white rounded-full p-2 transition-colors">
            ...
            <a href="https://instagram.com" aria-label="Instagram" target="_blank" rel="noopener noreferrer" className="bg-gray-800 hover:bg-[var(--golden-orange)] text-gray-300 hover:text-white rounded-full p-2 transition-colors">
            ...
            <a href="https://twitter.com" aria-label="Twitter" target="_blank" rel="noopener noreferrer" className="bg-gray-800 hover:bg-[var(--golden-orange)] text-gray-300 hover:text-white rounded-full p-2 transition-colors">
      ...
      <div className="max-w-6xl mx-auto px-4 mt-10 border-t border-gray-800 pt-6 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-gray-500 text-center md:text-left">
        ...
        <span>Made with <span className="text-[var(--gold)]">&#10084;</span> in Qatar</span>
      </div>
      <style jsx global>{`
